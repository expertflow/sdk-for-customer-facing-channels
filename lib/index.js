...
function sendCallMessage(message, dialogId) {
    ...
    if (_sessionall && _sessionall.response.dialog.callType === "OUT") {
        if (dialogStatedata && dialogStatedata.response && dialogStatedata.response.dialog) {
            destination = ((_a = dialogStatedata.additionalDetail) === null || _a === void 0 ? void 0 : _a.agentExt) || "";
        }
    }
    ...
    var message_targetUri_value = new SIP.URI("sip", destination, sipConfigs.uri);
